...
const HeroPage = () => {
  return (
    <Box className="bg-gradient-to-b from-green-100 to-white py-0 px-4 md:px-10 mb-4">
      <Box className="max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <Box className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <Typography className="text-gray-700 text-base sm:text-lg mt-4 leading-relaxed">
            ...
            Wasteology Solutions is sustainable waste collection and recycling company in India. Our core principle is that everything can be recycled with significant advancements in waste recycling. No material is waste when it reaches the right destination. 
          </Typography>
          ...
          <Typography className="text-gray-700 text-base sm:text-lg mt-4 leading-relaxed">
            ...
            and impactful. */}
            The real challenge lies in ensuring that every piece of waste is collected and sent to the appropriate recycling facility. Our mission is to create a system that simplifies waste collection for every unit in society,  be it households, residential communities, industries, or corporate..
          </Typography>
